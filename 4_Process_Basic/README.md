...
- 类型 pid_t，传统上是 **有符号** 的 16 位整形 数，如果 pid 用正数表示，则最多表示 2^15-1=32767。
...
#### fork()：create a child process
 ...
 // 和 setjmp 一样，也是执行一次，返回两次。 `pid_t fork(void); `
...
**例题：** 求 30000000 到 30000200 之间的质数
